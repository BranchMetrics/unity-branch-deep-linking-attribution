...
- [Changelog](https://github.com/BranchMetrics/unity-branch-deep-linking/blob/master/Changelog.md)
- [Troubleshooting](https://docs.branch.io/pages/apps/unity/#troubleshoot-issues)
